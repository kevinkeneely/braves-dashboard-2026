...
export const hitters = [
    ...
    { name:"Ozzie Albies", pos:"2B", pa:397, avg:".272", obp:".322", slg:".447", ops:".769", hr:14, rbi:51, r:60, h:97, doubles:20, triples:0, sb:1, bbpct:"6.8%", kpct:"12.8%", war:2.0, war2:1.8, wrc:107, woba:".331", xwoba:".296", oaa:2, frv:0, batSpeed:69.1, squaredUp:"28.8%", fastSwing:"5.7%", laSwSp:"33.9%", idealAttack:"57.9%", armValue:null, armStrength:70.8, abs:{netOvr:-0.3, netRuns:0.2, chal:6, won:3, lost:3, wonPct:"50%", chalRate:"5.2%", xChalRate:"5.6%", rateVsExp:"-0.5%"}, splits:{vsL:{pa:166,r:16,h:46,hr:6,rbi:22,avg:".295",obp:".313",slg:".487",ops:".800",wrc:112,woba:".339",iso:".192",bbpct:"2.4%",kpct:"6.0%",babip:".278"}, vsR:{pa:231,r:44,h:51,hr:8,rbi:29,avg:".255",obp:".329",slg:".415",ops:".744",wrc:104,woba:".325",iso:".160",bbpct:"10.0%",kpct:"17.7%",babip:".274"}, risp:{pa:94,r:3,h:25,hr:3,rbi:37,avg:".333",obp:".362",slg:".507",ops:".868",wrc:122,woba:".353",iso:".173",bbpct:"8.5%",kpct:"8.5%",babip:".297"}, highLeverage:{pa:36,r:19,h:8,hr:2,rbi:10,avg:".258",obp:".333",slg:".516",ops:".849",wrc:127,woba:".361",iso:".258",bbpct:"8.3%",kpct:"13.9%",babip:".240"}, twoOuts:{pa:131,r:23,h:30,hr:3,rbi:15,avg:".238",obp:".267",slg:".357",ops:".624",wrc:69,woba:".274",iso:".119",bbpct:"3.1%",kpct:"14.5%",babip:".260"}}},
