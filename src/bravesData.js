...
export const hitters = [
    // Updated July 14, 2026 (morning) — twoOuts splits refreshed for all hitters from FanGraphs splits screenshots
    // vsL, vsR, risp, highLeverage splits preserved from prior updates; all top-level stats preserved
    ...
    { name:"Mauricio Dubón", pos:"LF/SS", pa:372, avg:".265", obp:".319", slg:".420", ops:".739", hr:10, rbi:51, r:42, h:91, doubles:19, triples:2, sb:2, bbpct:"6.7%", kpct:"14.2%", war:2.8, war2:2.1, wrc:103, woba:".324", xwoba:".319", oaa:8, frv:7, batSpeed:68.9, squaredUp:"27.7%", fastSwing:"2.9%", laSwSp:"35.4%", idealAttack:"38.0%", armValue:null, armStrength:88.6, abs:{netOvr:-3.7, netRuns:-1.0, chal:10, won:3, lost:7, wonPct:"30%", chalRate:"6.4%", xChalRate:"4.2%", rateVsExp:"+2.1%"}, splits:{vsL:{pa:139,r:13,h:31,hr:4,rbi:20,avg:".240",obp:".295",slg:".411",ops:".706",wrc:93,woba:".309",iso:".171",bbpct:"6.5%",kpct:"11.5%",babip:".248"}, vsR:{pa:233,r:29,h:60,hr:6,rbi:31,avg:".280",obp:".333",slg:".425",ops:".759",wrc:109,woba:".333",iso:".145",bbpct:"6.9%",kpct:"15.9%",babip:".316"}, risp:{pa:87,r:3,h:28,hr:3,rbi:43,avg:".350",obp:".388",slg:".563",ops:".951",wrc:160,woba:".409",iso:".213",bbpct:"5.7%",kpct:"10.3%",babip:".368"}, highLeverage:{pa:38,r:9,h:14,hr:1,rbi:22,avg:".400",obp:".447",slg:".629",ops:"1.076",wrc:195,woba:".461",iso:".229",bbpct:"7.9%",kpct:"7.9%",babip:".419"}, twoOuts:{pa:119,r:17,h:26,hr:2,rbi:25,avg:".236",obp:".294",slg:".364",ops:".658",wrc:81,woba:".291",iso:".127",bbpct:"7.6%",kpct:"11.8%",babip:".255"}}},
