...
export const hitters = [
     ...
     { name:"Mauricio Dubón", pos:"SS", pa:298, avg:".264", obp:".316", slg:".417", ops:".733", hr:8, rbi:43, r:32, h:73, doubles:14, triples:2, sb:1, bbpct:"6.5%", kpct:"15.0%", war:1.7, war2:1.6, wrc:100, woba:".318", xwoba:".320", oaa:8, frv:6, batSpeed:69.0, squaredUp:"26.9%", fastSwing:"3.0%", laSwSp:"38.8%", idealAttack:"37.0%", armValue:null, armStrength:89.9, abs:{netOvr:-3.7, netRuns:-1.0, chal:10, won:3, lost:7, wonPct:"30%", chalRate:"6.7%", xChalRate:"4.4%", rateVsExp:"+2.3%"}, splits:{vsL:{pa:116,r:16,h:25,hr:2,rbi:11,avg:".234",obp:".293",slg:".355",ops:".648",wrc:81,woba:".289",iso:".121",bbpct:"6.9%",kpct:"12.1%",babip:".253"}, vsR:{pa:177,r:19,h:46,hr:5,rbi:19,avg:".280",obp:".330",slg:".439",ops:".769",wrc:113,woba:".337",iso:".159",bbpct:"6.2%",kpct:"16.9%",babip:".318"}, risp:{pa:71,r:3,h:23,hr:3,rbi:37,avg:".354",obp:".400",slg:".615",ops:"1.015",wrc:180,woba:".435",iso:".262",bbpct:"7.0%",kpct:"11.3%",babip:".370"}, highLeverage:{pa:32,r:6,h:12,hr:1,rbi:21,avg:".414",obp:".469",slg:".690",ops:"1.158",wrc:220,woba:".494",iso:".276",bbpct:"9.4%",kpct:"9.4%",babip:".440"}}},
