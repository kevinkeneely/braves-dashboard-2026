...
export const hitters = [
    // Updated June 29, 2026 PM — vsL, vsR splits + ABS metrics refreshed from FanGraphs + Baseball Savant
    // RISP and High Leverage splits preserved at prior values (not in current screenshot batch)
    // Hidden players (Acuña, León, Tromp, Murphy) held per standing rules; values verified unchanged in screenshots
    ...
    { name:"Drake Baldwin", pos:"C", pa:261, avg:".255", obp:".337", slg:".463", ops:".800", hr:14, rbi:39, r:42, h:59, doubles:6, triples:0, sb:1, bbpct:"9.6%", kpct:"24.5%", war:1.8, war2:1.5, wrc:125, woba:".355", xwoba:".377", oaa:null, frv:-1, batSpeed:75.0, squaredUp:"24.4%", fastSwing:"52.4%", laSwSp:"39.9%", idealAttack:"47.8%", avgPop:1.92, armValue:null, armStrength:79.8, abs:{netOvr:0.6, netRuns:0.3, chal:1, won:1, lost:0, wonPct:"100%", chalRate:"0.8%", xChalRate:"3.6%", rateVsExp:"-2.8%"}, absCatch:{netOvr:9.4, netRuns:0.5, chal:28, won:21, lost:7, wonPct:"75%", chalRate:"1.9%", xChalRate:"2.1%", rateVsExp:"-0.2%"}, splits:{vsL:{pa:106,r:18,h:26,hr:7,rbi:16,avg:".274",obp:".349",slg:".516",ops:".865",wrc:140,woba:".376",iso:".242",bbpct:"8.5%",kpct:"22.6%",babip:".297"}, vsR:{pa:155,r:24,h:33,hr:7,rbi:23,avg:".243",obp:".329",slg:".426",ops:".756",wrc:109,woba:".331",iso:".184",bbpct:"10.3%",kpct:"25.8%",babip:".289"}, risp:{pa:61,r:0,h:16,hr:0,rbi:24,avg:".314",obp:".410",slg:".412",ops:".822",wrc:131,woba:".363",iso:".098",bbpct:"13.1%",kpct:"14.8%",babip:".372"}, highLeverage:{pa:16,r:11,h:4,hr:0,rbi:7,avg:".267",obp:".313",slg:".333",ops:".646",wrc:81,woba:".290",iso:".067",bbpct:"6.3%",kpct:"18.8%",babip:".333"}}},
