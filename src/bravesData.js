...
export const hitters = [
    ...
    { name:"Lane Thomas", pos:"LF/DH", bats:"R", throws:"R", dob:"1995-08-23", draftYear:2014, draftRound:5, draftPick:147, draftType:"MLB", pa:356, avg:".232", obp:".326", slg:".397", ops:".723", hr:11, rbi:40, r:35, h:72, doubles:18, triples:0, sb:8, bbpct:"11.8%", kpct:"24.7%", war:0.7, war2:0.9, wrc:102, woba:".321", xwoba:".318", oaa:-6, frv:-3, batSpeed:72.5, squaredUp:"25.2%", fastSwing:"24.4%", laSwSp:"36.8%", idealAttack:"60.2%", armValue:3, armStrength:92.2, abs:{netOvr:0, netRuns:0, chal:0, won:0, lost:0, wonPct:"0%", chalRate:"0.0%", xChalRate:"0.0%", rateVsExp:"0.0%"}, splits:{vsL:{pa:18,r:2,h:6,hr:1,rbi:3,avg:".375",obp:".444",slg:".688",ops:"1.132",wrc:208,woba:".480",iso:".313",bbpct:"11.1%",kpct:"33.3%",babip:".556"}, vsR:{pa:10,r:2,h:0,hr:0,rbi:0,avg:".000",obp:".100",slg:".000",ops:".100",wrc:-67,woba:".070",iso:".000",bbpct:"10.0%",kpct:"40.0%",babip:".000"}, risp:{pa:10,r:0,h:3,hr:0,rbi:2,avg:".333",obp:".400",slg:".444",ops:".844",wrc:137,woba:".374",iso:".111",bbpct:"10.0%",kpct:"20.0%",babip:".429"}, highLeverage:{pa:3,r:1,h:1,hr:0,rbi:1,avg:".333",obp:".333",slg:".333",ops:".667",wrc:85,woba:".297",iso:".000",bbpct:"0.0%",kpct:"33.3%",babip:".500"}, twoOuts:{pa:116,r:12,h:24,hr:4,rbi:18,avg:".242",obp:".353",slg:".424",ops:".778",wrc:119,woba:".346",iso:".182",bbpct:"13.8%",kpct:"28.4%",babip:".323"}}},
...
export const starters = [
  ...
  export const bullpen = [
   ...
   export const standings = [
     ...
     { team:"PHI", full:"Philadelphia Phillies", w:73,l:59,pct:".553",gb:"3.5", home:"38-30",away:"35-29", rs:601, ra:581, diff:+20, strk:"L1", l10:"9-1", highlight:false, srs:0.3 },
